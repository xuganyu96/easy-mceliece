...
__attribute__((noinline)) static void minmax_vector(int32 *x, int32 *y,
                                                    long long n) {
  if (n < 8) {
    while (n > 0) {
      int32_MINMAX(*x, *y);
...
__attribute__((noinline)) static void merge16_finish(int32 *x, int32x8 x0,
...
__attribute__((noinline)) static void int32_twostages_32(int32 *x,
                                                         long long n) {
  long long i;
...
int32_threestages(int32 *x, long long n, long long q) {
  long long k, i;
...
__attribute__((noinline)) static void int32_sort_2power(int32 *x, long long n,
                                                        int flagdown) {
  long long p, q, i, j, k;
  int32x8 mask;
