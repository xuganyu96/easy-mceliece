...
static crypto_uint64_signed crypto_uint64_signed_negative_mask(
...
static crypto_uint64 crypto_uint64_unequal_mask(crypto_uint64 crypto_uint64_x,
...
static crypto_uint64 crypto_uint64_equal_mask(crypto_uint64 crypto_uint64_x,
                                              crypto_uint64 crypto_uint64_y) {
  return ~crypto_uint64_unequal_mask(crypto_uint64_x, crypto_uint64_y);
}

static crypto_uint64 crypto_uint64_smaller_mask(crypto_uint64 crypto_uint64_x,
                                                crypto_uint64 crypto_uint64_y) {
  crypto_uint64 crypto_uint64_xy = crypto_uint64_x ^ crypto_uint64_y;
...
static crypto_uint64 crypto_uint64_min(crypto_uint64 crypto_uint64_x,
                                       crypto_uint64 crypto_uint64_y) {
...
static void crypto_uint64_minmax(crypto_uint64 *crypto_uint64_a,
