...
extern "C" {
#endif
extern int crypto_kem_mceliece8192128_ref_keypair(unsigned char *,
                                                  unsigned char *);
extern int crypto_kem_mceliece8192128_ref_enc(unsigned char *, unsigned char *,
                                              const unsigned char *);
extern int crypto_kem_mceliece8192128_ref_dec(unsigned char *,
                                              const unsigned char *,
                                              const unsigned char *);
#ifdef __cplusplus
}
