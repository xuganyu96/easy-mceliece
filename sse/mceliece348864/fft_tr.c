...
#include "consts.data"
  ...
  for (i = 0; i < GFBITS; i += 2) {
    for (j = 0; j < 64; j += 4) {
      buf[reversal[j + 0]] =
          vec128_set2x(vec128_extract(in[j / 2 + 0][i + 0], 0),
                       vec128_extract(in[j / 2 + 0][i + 1], 0));
      buf[reversal[j + 1]] =
          vec128_set2x(vec128_extract(in[j / 2 + 1][i + 0], 0),
                       vec128_extract(in[j / 2 + 1][i + 1], 0));
      buf[reversal[j + 2]] =
          vec128_set2x(vec128_extract(in[j / 2 + 0][i + 0], 1),
                       vec128_extract(in[j / 2 + 0][i + 1], 1));
      buf[reversal[j + 3]] =
          vec128_set2x(vec128_extract(in[j / 2 + 1][i + 0], 1),
