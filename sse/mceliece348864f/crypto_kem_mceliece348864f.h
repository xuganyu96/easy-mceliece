...
extern "C" {
#endif
extern int crypto_kem_mceliece348864f_sse_keypair(unsigned char *,
                                                  unsigned char *);
extern int crypto_kem_mceliece348864f_sse_enc(unsigned char *, unsigned char *,
                                              const unsigned char *);
extern int crypto_kem_mceliece348864f_sse_dec(unsigned char *,
                                              const unsigned char *,
                                              const unsigned char *);
#ifdef __cplusplus
}
...
#define crypto_kem_mceliece348864f_keypair                                     \
  crypto_kem_mceliece348864f_sse_keypair
...
#define crypto_kem_mceliece348864f_PUBLICKEYBYTES                              \
  crypto_kem_mceliece348864f_sse_PUBLICKEYBYTES
#define crypto_kem_mceliece348864f_SECRETKEYBYTES                              \
  crypto_kem_mceliece348864f_sse_SECRETKEYBYTES
...
#define crypto_kem_mceliece348864f_CIPHERTEXTBYTES                             \
  crypto_kem_mceliece348864f_sse_CIPHERTEXTBYTES
