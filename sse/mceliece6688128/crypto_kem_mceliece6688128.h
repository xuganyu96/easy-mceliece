...
extern "C" {
#endif
extern int crypto_kem_mceliece6688128_sse_keypair(unsigned char *,
                                                  unsigned char *);
extern int crypto_kem_mceliece6688128_sse_enc(unsigned char *, unsigned char *,
                                              const unsigned char *);
extern int crypto_kem_mceliece6688128_sse_dec(unsigned char *,
                                              const unsigned char *,
                                              const unsigned char *);
#ifdef __cplusplus
}
...
#define crypto_kem_mceliece6688128_keypair                                     \
  crypto_kem_mceliece6688128_sse_keypair
...
#define crypto_kem_mceliece6688128_PUBLICKEYBYTES                              \
  crypto_kem_mceliece6688128_sse_PUBLICKEYBYTES
#define crypto_kem_mceliece6688128_SECRETKEYBYTES                              \
  crypto_kem_mceliece6688128_sse_SECRETKEYBYTES
...
#define crypto_kem_mceliece6688128_CIPHERTEXTBYTES                             \
  crypto_kem_mceliece6688128_sse_CIPHERTEXTBYTES
