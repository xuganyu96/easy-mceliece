...
static inline vec128 vec128_set1_16b(uint16_t a) { return _mm_set1_epi16(a); }

static inline vec128 vec128_set1_32b(uint64_t a) { return _mm_set1_epi32(a); }

static inline vec128 vec128_set1_64b(uint64_t a) { return _mm_set1_epi64x(a); }

static inline vec128 vec128_setzero() { return _mm_setzero_si128(); }

#define vec128_extract(a, i) ((uint64_t)_mm_extract_epi64((vec128)(a), (i)))

static inline int vec128_testz(vec128 a) { return _mm_testz_si128(a, a); }
...
static inline vec128 vec128_setbits(uint64_t a) { return _mm_set1_epi64x(-a); }
