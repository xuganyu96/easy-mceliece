...
#define crypto_kem_mceliece460896_vec_CIPHERTEXTBYTES 156
#define crypto_kem_mceliece460896_vec_BYTES 32

#ifdef __cplusplus
extern "C" {
#endif
extern int crypto_kem_mceliece460896_vec_keypair(unsigned char *,
                                                 unsigned char *);
extern int crypto_kem_mceliece460896_vec_enc(unsigned char *, unsigned char *,
                                             const unsigned char *);
extern int crypto_kem_mceliece460896_vec_dec(unsigned char *,
                                             const unsigned char *,
                                             const unsigned char *);
#ifdef __cplusplus
}
...
#define crypto_kem_mceliece460896_PUBLICKEYBYTES                               \
  crypto_kem_mceliece460896_vec_PUBLICKEYBYTES
#define crypto_kem_mceliece460896_SECRETKEYBYTES                               \
  crypto_kem_mceliece460896_vec_SECRETKEYBYTES
...
#define crypto_kem_mceliece460896_CIPHERTEXTBYTES                              \
  crypto_kem_mceliece460896_vec_CIPHERTEXTBYTES
