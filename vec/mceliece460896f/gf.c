...
static inline gf gf_sq2(gf in) {
  ...
  const uint64_t B[] = {0x1111111111111111, 0x0303030303030303,
                        0x000F000F000F000F, 0x000000FF000000FF};

  const uint64_t M[] = {0x0001FF0000000000, 0x000000FF80000000,
...
static inline gf gf_sqmul(gf in, gf m) {
  ...
  const uint64_t M[] = {0x0000001FF0000000, 0x000000000FF80000,
                        0x000000000007E000};
...
/* return 1/den */
gf gf_inv(gf den) { return gf_frac(den, ((gf)1)); }
